...
class _KayitEklemeState extends State<KayitEkleme8> {
  ...
  void initState() {
    ...
    if (widget.initialNote != null) {
      ...
      selectedValue =
          null; // Yeni not eklerken varsayılan olarak hiçbir şey seçilmemiş olacak
    }
  }
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      color: Color.fromARGB(255, 233, 233,
                          231), // Dropdown beyaz arka planlı olacak
                    ...
                    child: DropdownButton<String>(
                      value: selectedValue,
                      isExpanded:
                          true, // Dropdown'un genişliği metinle uyumlu olacak
                      hint: const Padding(
                ...
                const Padding(
                  ...
                  child: Text(
                    "Notu Ekleyen ve Düzenleyen Bilgisi",
                    style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.bold,
                    ),
                ...
                Padding(
                  padding: const EdgeInsets.only(bottom: 16.0),
                  child: TextFormField(
                    initialValue: "Bu metin yalnızca okunabilir!",
                      readOnly: true,
